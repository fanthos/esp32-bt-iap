...
static uint8_t tl_status[16] = {0};
static uint8_t bt_connected = 0;
...
static void bt_app_rc_ctrl_evt(uint16_t cmd, void *param) {
    ...
    switch(cmd) {
    case PC_NEXT:
        key_send = ESP_AVRC_PT_CMD_FORWARD;
        break;
    case PC_PREV:
        key_send = ESP_AVRC_PT_CMD_BACKWARD;
        break;
    case PC_PLAY:
        key_send = ESP_AVRC_PT_CMD_PLAY;
        break;
    case PC_PAUSE:
        key_send = ESP_AVRC_PT_CMD_PAUSE;
        break;
    default:
        break;
    }
